...
/*	public static List<Date> getDayList(Integer year)
    ...
    /**
     * 得到一个据今天一定天数,且 格式为yyyy-MM-dd的字符串
     * @param day 相距天数
     * @return
     */
    public static String addDay2Today(Integer day) {
        return DateUtil.formatDate(DateUtil.DATE_FORMAT, DateUtil.addDay2Date(day, DateUtil.getNow()));
    }
    ...
    public static void main(String[] args) {
        ...
        Date date1 = getDate("2018-04-11");
        Date date2 = getDate("2018-04-11");
        
        List<Date> dateList = getBetweenDates(date1,date2);
