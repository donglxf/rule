...
public class CalculateUtils {
     ...
     * @return
     */
    public static double mul4Obj(Object var1, Object var2) {
        double var11 = 0.0,var22 = 0.0;

        if(var1 != null ){
            var11 = Double.parseDouble(var1.toString());
        }
        if(var2 != null ){
            var22 = Double.parseDouble(var2.toString());
        }else{
            var22 = 1.0;
        }
        BigDecimal b1 = new BigDecimal(Double.toString(var11));
        BigDecimal b2 = new BigDecimal(Double.toString(var22));
        return b1.multiply(b2).doubleValue();
    }
    /**
     * 四舍五入
