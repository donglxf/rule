...
layui.use(['table','form','myutil'], function(){
    ...
    var preUrl = common.config.ruleServicePath.basePath ;
    //查询构造
    ...
    entityTable.render({
        ...
        ,height: 550
        ,cellMinWidth: 80
        ,url: preUrl + 'constantInfo/page' //数据接口
...
//            conId = data.conId;
    ...
    itemTable.render({
        ...
        ,height: 550
        ,cellMinWidth: 80
        ,url: preUrl+'constantItemInfo/getAll/' //数据接口
        // data:[{"conId":1,"entityName":"测试规则","entityDesc":"测试规则引擎","entityIdentify":"testrule","pkgName":"com.sky.testrule","creUserId":1,"creTime":1500522092000,"isEffect":1,"remark":null}]
        ,page: false
        ,id:'itemT'
        ,cols: [[ //表头
    ...
    $("#entity_btn_add").on('click',function () {
        ...
        $.get('rule_constant_edit.html', null, function (form) {
            topIndex =  layer.open({
                type :1,
                title : '新增分类',
                maxmin : true,
    ...
    function  edit(id) {
        ...
        $.get(preUrl+"constantInfo/getInfoById?id="+id,function (data) {
    ...
    $("#entity_item_btn_add").on('click',function () {
        ...
        $.get('rule_constant_item_edit.html', null, function (form) {
            topIndex =   layer.open({
                type :1,
                title : '新增',
                maxmin : true,
