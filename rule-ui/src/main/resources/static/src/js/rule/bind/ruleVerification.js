...
layui.use(['table','form','laytpl','myutil'], function(){
    ...
    var preItemUrl = config.ruleServicePath.basePath+config.ruleServicePath.entityItemInfo.base;
    var preUrl =config.ruleServicePath.basePath+config.ruleServicePath.entityInfo.base;
    //第一个实例
    entityTable.render({
        elem: '#demo'
        ,height: 550
